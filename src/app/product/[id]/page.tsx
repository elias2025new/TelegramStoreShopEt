        ...
        <PageTransition>
            ...
            >
                ...
                <div className="absolute top-0 left-0 right-0 z-50 p-4 pt-safe flex items-center justify-between pointer-events-none">
                    <Link href="/" className="pointer-events-auto p-3 bg-black/40 backdrop-blur-md rounded-full text-white shadow-sm border border-white/10 hover:bg-black/60 transition-colors">
