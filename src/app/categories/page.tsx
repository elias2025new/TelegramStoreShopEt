            ...
            <main className="min-h-screen bg-black pb-36 font-sans">
                ...
                >
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-xl font-bold text-[#cba153] font-serif tracking-wide">Collections</h1>
                    </div>
                </header>
                ...
                <div className="px-6 mt-6 space-y-4">
                    {CATEGORIES.map((cat) => (
                        <Link
                            ...
                            className="flex items-center gap-4 p-4 bg-[#111111] border border-white/5 rounded-2xl active:scale-[0.98] transition-all hover:border-[#cba153]/30"
                        >
                            <div className="w-14 h-14 bg-[#1a1a1a] rounded-xl flex items-center justify-center border border-[#1a1a1a]">
                                <img
