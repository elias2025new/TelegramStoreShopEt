                    ...
                    {tabs.map((tab) => {
                        ...
                        return (
                            <Link
                                key={tab.name}
                                href={tab.href}
                                className={`relative flex flex-col items-center justify-center py-2 px-5 rounded-2xl transition-all duration-200 ${isActive ? 'text-[#cba153]' : 'text-gray-500 hover:text-gray-300'
                                    }`}
                            >
                                {isActive && (
                                ...
                                <img
                                    ...
                                    alt={tab.name}
                                    className={`w-6 h-6 transition-all duration-200 ${isActive ? 'scale-105' : 'scale-100'}`}
                                />
                                {isActive && (
